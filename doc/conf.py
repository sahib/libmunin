...
# -*- coding: utf-8 -*-
#
# libmunin documentation build configuration file, created by
...
latex_documents = [
  ('index', 'libmunin.tex', 'libmunin Documentation',
...
man_pages = [
    ('index', 'libmunin', 'libmunin Documentation',
     ['Christopher Pahl'], 1)
]
...
texinfo_documents = [
  ('index', 'libmunin', 'libmunin Documentation',
   'Christopher Pahl', 'libmunin', 'One line description of project.',
   'Miscellaneous'),
]
